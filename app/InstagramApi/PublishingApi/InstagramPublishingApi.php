...
class InstagramPublishingApi {
    ...
    public function post() {
        ...
        //$this->browser->pause(3000)->driver->findElement(WebDriverBy::cssSelector('input.tb_sK'))->setFileDetector(new LocalFileDetector())->sendKeys(storage_path('kep.jpg'))->submit();
        $a = new Test;
        $a->Login("janikahidvegi1234", "almafa1234");
        $a->UploadPhoto(storage_path("alma.jpg"), "ASDF");
    }
